...
/*
 * RISC-V RPMI Based Performance Driver through SBI MPXY
 *
 * Copyright (C) 2025 Shanghai StarFive Technology Co., Ltd.
 *
 * Implements a CPUFreq driver on top of SBI RPMI Message Proxy Extension (MPXY)
 *
...
static int rpmi_cpufreq_probe(struct platform_device *pdev)
{
	...
	dev_info(dev, "%d MPXY PM domains are found\n", num_domains);
